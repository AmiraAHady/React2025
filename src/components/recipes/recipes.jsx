...
function Recipes() {
  const [recipeList, setRecipeList] = useState([
    {
      id: 1,
      name: "classNameic Margherita Pizza",
      ingredients: [
        "Pizza dough",
        "Tomato sauce",
    ...
    },
    {
      ...
      instructions: [
        ...
        "Serve slices of moussaka warm and enjoy this Greek classNameic!",
      ],
      prepTimeMinutes: 45,
      cookTimeMinutes: 45,
      servings: 6,
    ...
    },
    {
      ...
      instructions: [
        ...
        "Serve hot over jasmine rice and enjoy this Thai classNameic!",
      ],
      prepTimeMinutes: 20,
      cookTimeMinutes: 30,
      servings: 4,
    ...
    },
    {
      ...
      instructions: [
        ...
        "Indulge in the decadence of this classNameic Italian Tiramisu!",
      ],
      prepTimeMinutes: 30,
      cookTimeMinutes: 0,
      servings: 6,
  ...
  // mounting
  useEffect(() => {
    console.log("function component mounting phase");
  }, []);
  //updating
  useEffect(() => {
  ...
  return (
    <>
      <div className="container">
        <button className="btn btn-danger" onClick={()=>setIsAuth(!isAuth)}>
          Toggle Auth
        </button>
        {/* {isAuth&&<>hello</>} */}
        ...
        {isAuth ? (
          ...
          <h1>You Must Login To see Products</h1>
        )}
      </div>
    </>
  );
